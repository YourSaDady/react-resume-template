  ...
  description: (
    <>
      <div className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I&apos;m a final-year CS undergrad at{' '}
        <strong className="text-stone-100">the University of Hong Kong (HKU)</strong>, supervised by{' '}
        <a
          className="text-stone-100 underline hover:text-stone-50"
          href="https://ikekonglp.github.io/"
      ...
      <div className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        My current research goal is to popularize <strong className="text-stone-100">Energy-Based Models</strong> by
        advancing their theoretical boundaries and developing competitive real-world deployments, with a focus on
        long-horizon planning.
      </div>
      <div className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        In my free time, you can catch me working at <strong className="text-stone-100">Chi Wah Building@HKU</strong>,
        jogging along the <strong className="text-stone-100">Victoria Harbour</strong>, or exploring new restaurants
        with my friends.
      </div>
    </>
  ),
...
export const aboutData: About = {
  ...
  description: (
    <>
      <div>
        ...
        <a
          className="underline text-stone-100 hover:text-stone-50"
          href="https://www.cs.toronto.edu/~six/"
          rel="noopener noreferrer"
          target="_blank">
          Prof. Xujie Si
        </a>{' '}
        to conduct model-based verification of transformer robustness during summer 2024 at the University of Toronto,
        supported by{' '}
        <a
          className="underline text-stone-100 hover:text-stone-50"
      ...
      <div>
        The unpredictable parametric knowledge stored in such models motivated me to seek generative measures that are
        theoretically grounded and not confined to text, which led me to energy-based models (EBMs). Presently, I am
        exploring EBM-based measures for generalizable test-time sampling and compositional spatial planning under the
        supervision of{' '}
        <a
          className="underline text-stone-100 hover:text-stone-50"
          href="https://yilundu.github.io/"
  ...
  aboutItems: [
    ...
    {label: 'Study', text: 'University of Hong Kong(B.Eng)', Icon: AcademicCapIcon},
    {
      ...
      text: 'EBMs, Contrastive Learning, Mechanistical Interpretability',
      Icon: SparklesIcon,
    },
...
export const collaborators: Collaborators[] = [
  {
    name: 'Chang Ma',
    homepagelink: 'https://chang-github-00.github.io/-changma/',
    message: 'Mentored me on IntrospectiveReasoning',
  },
  {
    name: 'Shiqi Chen',
    homepagelink: 'https://shiqichen17.github.io/',
    message: 'Mentored me on IntrospectiveReasoning',
  },
  // ↓↓↓  add more here
];
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      'Dec 1st, 2024: I play bass and violin for the X&Y band @HKU_Landman. We had our first live show with other amazing bands.',
